...
<body class="flex flex-col selection:bg-sky-200 selection:text-slate-800">
    ...
    <div class="flex flex-col w-full min-h-screen ">
        ...
        <!-- content -->
        <div class="flex flex-col flex-grow w-full text-gray-600">
            ...
            <div class="flex flex-col gap-6 px-4 py-16 md:px-8 lg:px-32">
                ...
                <?php if ($show_data == true) : ?>
                    <div class="flex flex-col gap-8">
                        <!-- table output -->
                        <div class="overflow-hidden text-sm border border-gray-200 shadow-md lg:text-base">


                            <div class="flex flex-col h-full overflow-auto bg-white shadow-md">
                                ...
                                <table class="w-full text-xs text-left text-gray-500" id="myTable">
                                    <thead class="text-xs text-gray-800 uppercase bg-gray-100 border-t border-b border-t-gray-200 border-b-gray-200">
                                        <tr>
